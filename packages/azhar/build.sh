...
TERMUX_PKG_DEPENDS="jack, opengl, pipewire, sdl2, qt6-qtbase, libxext, libx11, openssl, cryptopp, spirv-tools, nlohmann-json, catch2, portaudio, boost, fmt, ffmpeg, rapidjson, zstd, libusb"
