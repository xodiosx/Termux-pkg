...
TERMUX_PKG_DEPENDS="jack, opengl, pipewire, qt6-qtbase, libxext, libx11, openssl, cryptopp, spirv-tools, nlohmann-json, catch2-static, libenet, portaudio, boost, fmt, ffmpeg, rapidjson, zstd, libusb"
