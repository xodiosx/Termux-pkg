...
TERMUX_PKG_DEPENDS="jack, opengl, pipewire, qt6-qtbase, libxext, libx11, openssl, cryptopp, spirv-tools, nlohmann-json, libenet, portaudio, boost, fmt, ffmpeg, rapidjson, zstd, libusb"
TERMUX_PKG_BUILD_DEPENDS="cmake, vulkan-headers, spirv-headers, libcpufeatures, catch2-static"
