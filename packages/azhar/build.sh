...
TERMUX_PKG_DEPENDS="jack, opengl, catch2-static, pipewire, qt6-qtbase, libxext, libx11, openssl, cryptopp, spirv-tools, nlohmann-json, libenet, portaudio, boost, fmt, ffmpeg, rapidjson, zstd, libusb"
