...
TERMUX_PKG_DEPENDS="jack, opengl, pipewire, qt6-qtbase, libxext, libx11, catch2-static, openssl, cryptopp, spirv-tools, nlohmann-json, libenet, portaudio, boost, fmt, ffmpeg, rapidjson, zstd, libusb"
