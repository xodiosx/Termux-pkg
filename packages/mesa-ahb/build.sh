...
TERMUX_PKG_DEPENDS="libc++, zlib, zstd, libxcb, libandroid-shmem, libdrm, libglvnd, libllvm (<< $TERMUX_LLVM_NEXT_MAJOR_VERSION), libwayland, libx11, libxext, libxfixes, libxxf86vm, ncurses, vulkan-loader"
